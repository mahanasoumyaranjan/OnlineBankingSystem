...
.styled-table tbody tr.active-ro {
	font-weight: bold;
	color: #009879;
}
...
<body>
	...
	<div id="top_links">
		...
		<div id="header">
			<h1>
				CGLIA - BANK<span class="style1"></span>
			</h1>
		...
		<div class="container">
			<div class="row">
				...
				out.println(
						"<thead><tr><th>NAME</th><th>EMAIL</th><th>MOBILE NUMBER</th><th>DOB</th><th>ADDRESS</th><th>GENDER</th><th>EMP_TYPE</th></tr></thead>");
				for (EmpInfo u : list) {
					out.println("<tbody><tr><td>" + u.getName() + "</td><td>" + u.getEmail() + "</td><td>" + u.getMobile() + "</td><td>"
					+ u.getDob() + "</td><td>" + u.getAddress() + "</td><td>" + u.getGender() + "</td><td>" + u.getEmp_type()
					+ "</td></tr></tbody>");
				}
				%>
			</div>
			...
			<tr align="justify">
				<td class="con" valign="top">
					...
					<p>
						...
						bank which provides loan and helps you financially..<br>
						<br>
					</p>
				</td>
