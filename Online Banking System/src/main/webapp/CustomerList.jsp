...
<body>
	...
	<div id="top_links">
		...
		<div id="header">
			...
			<h1>
				DOLPHIN - BANK<span class="style1"></span>
			</h1>
		...
		<div class="container">
			<div class="row">
				...
				out.println(
						"<thead><tr><th>Customer Name</th><th>Email</th><th>Mobile Number</th><th>DOB</th><th>Gender</th></tr></thead>");
				for (CustomerInfo u : list) {
					out.println("<tbody><tr><td>" + u.getName() + "</td><td>" + u.getEmail() + "</td><td>" + u.getMobile() + "</td><td>"
					+ u.getDob() + "</td><td>" + u.getGender() + "</td></tr></tbody>");
				}
